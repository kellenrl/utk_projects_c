 ...
 *
 * This is the main src file for lab2 part 3
 */
...
int main (int argc, char *argv[])
{
	...
	//read in the entire fill into a buffer and close the file
	...
	while(pos < fsize) {
		...
		//traverse ip->names and insert ip struct ptrs into JRB tree of lists
